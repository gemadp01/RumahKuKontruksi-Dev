    ...
    return (
        <Drawer isOpen={isOpen} onClose={onClose}>
            ...
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold">Detail Mandor</h2>
                <IconButton icon={<X size={22} />} onClick={onClose} />
            </div>

            {/* PROFILE */}
            <ProfileSection
                foto={mandor.foto || "https://placehold.co/200"}
            ...
            <div className="space-y-4 mt-4">
                <DetailItem icon={<User />} label="ID Mandor" value={mandor.kode_mandor} />
                <DetailItem icon={<User />} label="NIK" value={mandor.nik} />
                <DetailItem icon={<Mail />} label="Email" value={mandor.email || "-"} />
                <DetailItem icon={<Phone />} label="Nomor HP" value={mandor.no_hp || "-"} />
                <DetailItem icon={<MapPin />} label="Alamat" value={mandor.alamat || "-"} />
                <DetailItem
                    icon={<User />}
